...
const products = [
  ...
  { id: 5, name: 'Mini Crossbody Bag', category: 'bags', color: 'green', size: 'small', price: 35 },
  { id: 6, name: 'Travel Duffel', category: 'bags', color: 'black', size: 'x-large', price: 95 },
  { id: 7, name: 'Cotton Hoodie', category: 'clothing', color: 'red', size: 'large', price: 72 },
  { id: 8, name: 'Linen Shirt', category: 'clothing', color: 'white', size: 'medium', price: 42 },
  { id: 9, name: 'Denim Jacket', category: 'clothing', color: 'blue', size: 'x-large', price: 110 },
  { id: 10, name: 'Leather Strap Watch', category: 'watches', color: 'black', size: 'medium', price: 180 },
  { id: 11, name: 'Sport Timer Watch', category: 'watches', color: 'yellow', size: 'large', price: 135 },
  { id: 12, name: 'Classic Silver Watch', category: 'watches', color: 'white', size: 'small', price: 220 },
  { id: 13, name: 'Gold Hoop Earrings', category: 'jewelry', color: 'yellow', size: 'small', price: 75 },
  { id: 14, name: 'Emerald Pendant', category: 'jewelry', color: 'green', size: 'medium', price: 145 },
  { id: 15, name: 'Black Stone Ring', category: 'jewelry', color: 'black', size: 'small', price: 88 },
